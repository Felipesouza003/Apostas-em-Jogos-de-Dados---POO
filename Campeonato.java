    ...
    public void incluirJogador() {
        ...
        if (numJog < 10) {
            ...
            if (tipo == 'h' || tipo == 'H') {
                ...
                jogadores[numJog] = new Humano(nome, tipo, Cpf, conta, numeroBanco, agencia);// Atribui um novo jogador
                                                                                             // ao vetor de jogadores.
                numJog++;// Como um novo jogador foi incluido aumenta-se a variavel contadora de
                         // jogadores
        ...
        } else// Caso o limite de jogadores seja atingido impede a inclusao de um novo
              // jogador.
        ...
        if (opcao == 1) {
            if (ExisteHumano() == false)
                ...
                for (int i = 0; i < numJog; i++) {
                    if (jogadores[i] instanceof Humano) {
                        System.out
                                .println("Nome:" + jogadores[i].GetNome() + "(H) Saldo: R$ " + jogadores[i].GetSaldo());
                    }
                }
            }
        } else if (opcao == 2) {
            if (ExisteMaquina() == false)
                ...
                for (int i = 0; i < numJog; i++) {
                    if (jogadores[i] instanceof Maquina) {
                        System.out
                                .println("Nome:" + jogadores[i].GetNome() + "(M) Saldo: R$ " + jogadores[i].GetSaldo());
                    }
                }
            }
        } else {
